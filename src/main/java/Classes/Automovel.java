 ...
 * @author beatr
 */
public class Automovel implements VeiculoI{
        private int ano;
        ...
        public Automovel(int ano, String placa, Categoria categoria, double valorDeVenda, Marca marca, ModeloAutomovel modelo){
            this.ano = ano;
            this.placa = placa;
