 ...
 * @author beatr
 */
public class Motocicleta implements VeiculoI {
    private int ano;
    ...
    public Motocicleta(int ano, String placa, Categoria categoria, double valorDeVenda, Marca marca, ModeloMotocicleta modelo){
        this.ano = ano;
        this.placa = placa;
